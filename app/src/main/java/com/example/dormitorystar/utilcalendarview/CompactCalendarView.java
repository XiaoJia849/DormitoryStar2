...
public class CompactCalendarView extends View {
    ...
    private final com.example.dormitorystar.utilcalendarview.AnimationHandler animationHandler;
    private com.example.dormitorystar.utilcalendarview.CompactCalendarController compactCalendarController;
//    手势识别
...
//        翻动日历
    ...
    public CompactCalendarView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        compactCalendarController = new com.example.dormitorystar.utilcalendarview.CompactCalendarController(new Paint(), new OverScroller(getContext()),
                ...
                Color.argb(255, 100, 68, 65), new com.example.dormitorystar.utilcalendarview.EventsContainer(Calendar.getInstance()),
                Locale.getDefault(), TimeZone.getDefault());
        gestureDetector = new GestureDetectorCompat(getContext(), gestureListener);
        animationHandler = new com.example.dormitorystar.utilcalendarview.AnimationHandler(compactCalendarController, this);
    }
