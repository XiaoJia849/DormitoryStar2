...
public class AnimationHandler {
    ...
    private void setUpAnimationLisForExposeOpen(final Animator indicatorAnim, Animation heightAnim) {
        heightAnim.setAnimationListener(new com.example.dormitorystar.utilcalendarview.AnimationListener() {
            @Override
    ...
    private void setUpAnimationLisForOpen(Animation openAnimation) {
        openAnimation.setAnimationListener(new com.example.dormitorystar.utilcalendarview.AnimationListener() {
            @Override
            public void onAnimationEnd(Animation animation) {
