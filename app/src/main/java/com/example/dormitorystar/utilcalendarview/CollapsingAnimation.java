...
public class CollapsingAnimation extends Animation {
    ...
    public CollapsingAnimation(CompactCalendarView view, com.example.dormitorystar.utilcalendarview.CompactCalendarController compactCalendarController, int targetHeight, int targetGrowRadius, boolean down) {
        this.view = view;
